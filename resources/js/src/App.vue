<script setup>
import hotelLogo from '../../assets/img/hotel_logo.png';
...
<!--    ifdgfdg-->
        <div class="header">
            <div class="header-left">
                <a href="index.html" class="logo">   <img :src="hotelLogo" alt="Hotel Logo" width="50" height="70" > <span class="logoclass">HOTEL</span> </a>
                <a href="index.html" class="logo logo-small"> <img :src="hotelLogo" alt="Logo" width="30" height="30"> </a>
            </div>
                                ...
                                <li class="notification-message">
                                    <a href="#">
                                        <div class="media"> <span class="avatar avatar-sm">
											<img class="avatar-img rounded-circle" alt="User Image" :src="avatar02">
											</span>
...
<!--                        <span class="user-img">-->
<!--                        <img class="rounded-circle" src="/assets/img/profiles/avatar-01.jpg" width="31" alt="Soeng Souy"></span> -->
                    </a>
                    <div class="dropdown-menu">
                        <div class="user-header">
                            <div class="avatar avatar-sm">
                                <img :src="avatar01" alt="User Image" class="avatar-img rounded-circle">
                            </div>
                            <div class="user-text">
                                <h6>Soeng Souy</h6>
